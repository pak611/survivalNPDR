...
#' @export
npdrDiff <- function(a, b, diff.type = c("manhattan", "numeric-abs", "numeric-sqr", "allele-sharing", "match-mismatch", "correlation-data", "binomial-surv", "keep-same", "standard", "reverse-std"), norm.fac = 1) {
  ...
  val <- switch(diff.type,
                ...
                `standard` = a - b, # standard difference
                `reverse-std` = b - a # reverse standard difference
