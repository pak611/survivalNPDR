...
set.seed(123)
k_folds <- createFolds(dat$status, k = 20, list = TRUE, returnTrain = TRUE)
...
write.csv(results_summary, "paper_tables/results_summary_interactions_with_ranger.csv", row.names = FALSE)
...
ggsave("paper_graphics/c_index_auc_boxplot_filtered.png", plot = combined_plot, width = 20, height = 20)
