...
write.csv(errors, "paper_tables/PR_K_AUC_interactions.csv", row.names = FALSE)

# Read in the errors data frame from the CSV file
errors <- read.csv("paper_tables/PR_K_AUC_interactions.csv")
...
# Save the plot
ggsave("paper_tables/AUC_K_interactions_overlay_legend.png", width = 12, height = 8, dpi = 300)



# Read in interaction errors and main errors and plot them side by side
errors_interaction <- read.csv("paper_tables/PR_K_AUC_interactions.csv")
errors_main <- read.csv("paper_tables/PR_K_AUC.csv")
...
# Save the plot
ggsave("paper_tables/AUC_K_main_vs_interaction.png", width = 12, height = 15, dpi = 300)
